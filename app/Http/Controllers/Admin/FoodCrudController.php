...
class FoodCrudController extends CrudController
{
    ...
    {
        CRUD::column('food_name');
        CRUD::column('food_price');
        CRUD::column('food_picture');
        CRUD::column('food_desc');
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('food_name');
        CRUD::field('food_price');
        CRUD::field('food_picture');
        CRUD::field('food_desc');
